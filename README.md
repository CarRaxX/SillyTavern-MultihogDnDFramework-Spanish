### 📢 New: Persistent maps. The framework now generates persistent maps that are automatically updated and even evolved offscreen. Explore a dungeon or a town, leave, come back later, and continue. What you come back is likely not the exact same thanks to Map Evolution. The dungeon might've repopulated, enemies might've set up ambushes, and so no. Dungeons are also no longer hallucinated but skill checks actually matter.

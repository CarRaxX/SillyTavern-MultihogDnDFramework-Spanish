...
import { formatDungeonMapForPlayer } from './dungeon-reality.js';
...
async function buildMapContext() {
    try {
        ...
        return `## ACTIVE SITE MAP (player-facing, same knowledge as Visuals/Map)
Use this to discuss exploration and possible actions. Unexplored neighbors are unknown — do not invent hidden rooms, traps, or occupants.

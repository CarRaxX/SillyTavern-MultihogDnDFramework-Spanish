    ...
    setTimeout(() => {
        ...
        const openEditor = (index = -1) => {
            ...
            editor.innerHTML = `
                ...
                <div style="font-size:10px;opacity:.62;margin-bottom:5px;overflow-wrap:anywhere;">Selecciona los módulos a renderizar bajo esta cabecera compartida. Los módulos fijados especiales no están disponibles durante la BETA.</div>

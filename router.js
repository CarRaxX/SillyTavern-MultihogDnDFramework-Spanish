...
export async function runRouterPass(narrativeOutput, manualPrompt = null, customLookback = null, isManual = false, newlyTriggeredIds = [], overrideChatLog = null) {
    ...
    try {
        ...
        const routerSettings = {
            ...
            maxTokens: (settings.routerMaxTokens !== undefined && settings.routerMaxTokens !== null && settings.routerMaxTokens !== '' && Number(settings.routerMaxTokens) > 0) ? Number(settings.routerMaxTokens) : 4096,
        };

...
export const DEFAULT_MODULES = {
    ...
    world: { enabled: false, tag: 'WORLD', format: 'Name | Details | Keywords', instruction: 'World Progression reports tracking location-scale conditions and wider currents. Name must be the time period (e.g. "Day 1", "Week 1 (Days 1-7)").' },
};

...
export const AGENT_CONNECTION_SETUPS = [
    ...
    },
    {
        ...
        label: 'Creación de Personajes y Modos Iniciales',
        settingsKeys: {
    ...
    },
    {
        ...
        label: 'Asistente de Sistemas de Juego',
        settingsKeys: {

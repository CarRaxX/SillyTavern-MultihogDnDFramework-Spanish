...
export const MAP_THEME_FIELDS = Object.freeze([
    { key: 'background', label: 'Lienzo / Fondo', group: 'Mapa' },
    { key: 'textbox', label: 'Fondo de caja de texto', group: 'Mapa' },
    { key: 'frame', label: 'Marco', group: 'Mapa' },
    { key: 'node', label: 'Área no visitada', group: 'Áreas' },
    { key: 'nodeDiscovered', label: 'Área visitada', group: 'Áreas' },
    { key: 'nodeFog', label: 'Área oculta (Niebla)', group: 'Áreas' },
    { key: 'text', label: 'Texto de área', group: 'Áreas' },
    { key: 'textMuted', label: 'Texto visitado', group: 'Áreas' },
    { key: 'accent', label: 'Área actual', group: 'Áreas' },
    { key: 'route', label: 'Ruta abierta', group: 'Rutas' },
    { key: 'routeLocked', label: 'Cerrada / bloqueada', group: 'Rutas' },
    { key: 'routeBlocked', label: 'Obstruida / destruida', group: 'Rutas' },
    { key: 'creature', label: 'Criatura', group: 'Activos' },
    { key: 'group', label: 'Grupo', group: 'Activos' },
    { key: 'trap', label: 'Trampa', group: 'Activos' },
    { key: 'hazard', label: 'Peligro', group: 'Activos' },
    { key: 'alarm', label: 'Alarma', group: 'Activos' },
    { key: 'barrier', label: 'Barrera', group: 'Activos' },
    { key: 'object', label: 'Objeto', group: 'Activos' },
    { key: 'loot', label: 'Botín', group: 'Activos' },
    { key: 'effect', label: 'Efecto', group: 'Activos' },
    { key: 'other', label: 'Otro', group: 'Activos' },
]);

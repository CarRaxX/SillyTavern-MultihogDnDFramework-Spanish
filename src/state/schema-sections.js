...
export const DEFAULT_PC_SECTIONS = [
    ...
    { id: 'sec_body', name: 'Cuerpo', description: '[Describe rasgos físicos: tipo de cuerpo, altura, cabello, ojos, tono de piel, marcas distintivas, cicatrices y lenguaje corporal natural. NO describas ropa o armadura aquí — pertenecen a Equipo Equipado.]', icon: '👁️', color: '#d4a940' },
    { id: 'sec_equipment', name: 'Equipo Equipado', description: '[Describe solo el equipo que lleva puesto/transporta actualmente — armas, armaduras, ropa, accesorios visibles en el personaje. NO monedas, bolsas de botín ni listas de inventario. Se actualiza conforme cambia el equipo equipado en el juego.]', icon: '🎽', color: '#f59e0b' },

...
- DUNGEON maps are only for that kind of high-risk interior. Do not call \`CreateAreaMap\` for an ordinary house, shop, inn, alley, rooftop, warehouse, street, or other mundane sub-place. Map a building as DUNGEON only when that building itself is a dungeon, ruin, lair, stronghold, or trapped complex.
...
- Map identity: \`site\` is copied character-for-character from the Location footer segment that names this mapped dungeon or the town/city/village — never translated, transliterated, expanded, or retitled. Never map an incidental nested alley/house/shop leaf. \`entrance\` is copied the same way from the named entrance (settlement gate/square or dungeon door). A distinct site title must already appear in the footer.

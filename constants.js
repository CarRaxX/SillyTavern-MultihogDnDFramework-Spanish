...
- Before narrating entry into an unmapped town, city, village, or similar settlement, call \`CreateAreaMap\` exactly once with kind SETTLEMENT, its exact footer root, current entrance (gate, square, docks, etc.), scale, threat, and established premise.
...
- Map identity: \`site\` is copied character-for-character from the Location footer segment that names this mapped dungeon/settlement — never translated, transliterated, expanded, or retitled. \`entrance\` is copied the same way from the current footer leaf or named entrance. A distinct site title must already appear in the footer.
